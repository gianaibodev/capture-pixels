...
export default function FacebookSection() {
  return (
    <section className="py-24 bg-background border-t border-border relative overflow-hidden">
      ...
      <div className="absolute -right-40 -top-40 w-96 h-96 bg-blue-500/20 rounded-full blur-[128px] pointer-events-none" />
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 bg-card/50 backdrop-blur-sm border border-border/50 p-8 md:p-12 rounded-3xl shadow-xl">
